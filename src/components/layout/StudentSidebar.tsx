...
export const StudentSidebar: React.FC<StudentSidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-50 bg-white border-r border-slate-200/80 flex flex-col justify-between transition-all duration-300 ease-in-out select-none shadow-sm',
      ...
      >
        ...
        <div
          className={cn(
            'h-20 flex items-center px-5 border-b border-slate-100 transition-all shrink-0',
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden min-h-0 py-2 space-y-4">
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={cn(
                    'flex items-center gap-3.5 px-4 py-2.5 rounded-xl text-xs font-bold transition-all group relative',
                ...
                >
                  <Icon
                    className={cn(
                      ...
                      active ? 'text-white' : 'text-slate-400 group-hover:text-[#0158FC]'
                    )}
                  />
          ...
          <div className={cn('px-3', isCollapsed && 'lg:hidden')}>
            <div className="rounded-2xl bg-gradient-to-b from-[#f0f7ff] to-[#e4f0fe] border border-blue-100/90 p-4 text-center relative overflow-hidden">
              <div className="w-8 h-8 rounded-full bg-amber-100 text-amber-500 flex items-center justify-center mx-auto mb-2 shadow-2xs">
                <Crown className="w-4 h-4 fill-amber-500" />
              </div>
              <h4 className="text-xs font-black text-slate-900 uppercase tracking-wide mb-0.5">
                PRO PASS
              </h4>
              ...
              <div className="space-y-1.5 text-left text-[11px] font-semibold text-slate-700 mb-4 px-1">
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[#0158FC] shrink-0" />
                  <span>All Exams</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[#0158FC] shrink-0" />
              ...
              <button
                ...
                className="w-full py-2 rounded-xl bg-[#0158FC] hover:bg-blue-700 text-white text-xs font-bold shadow-xs transition-all flex items-center justify-center gap-1 cursor-pointer"
              >
        ...
        <div className="p-3 border-t border-slate-100 shrink-0 relative bg-white">
          ...
          <button
            ...
            className={cn(
              ...
              isCollapsed
                ? 'justify-center hover:bg-slate-100 p-1.5'
                : 'hover:bg-slate-50 border border-slate-200/80 hover:border-slate-300'
            )}
          ...
          >
            ...
            {!isCollapsed && (
              <ChevronUp
                className={cn(
                  'w-4 h-4 text-[#0158FC] transition-transform duration-200 shrink-0',
          ...
          {profileDropdownOpen && (
            <div
              className={cn(
                'bg-white rounded-2xl shadow-2xl border border-slate-200/90 py-2 z-50 animate-in fade-in zoom-in-95 duration-100',
                isCollapsed
            ...
            >
              ...
              <div className="py-1">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-4 py-2 text-xs text-slate-700 hover:bg-slate-50 font-medium transition-colors text-left cursor-pointer"
                >
