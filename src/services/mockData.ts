  ...
  'test-wbp-mock-01': [
    {
      ...
      optionA: 'Venus (শুক্র)',
      optionB: 'Mars (মঙ্গল)',
      optionC: 'Jupiter (বৃহস্পতি)',
      optionD: 'Saturn (শনি)',
      correctOption: 'B',
      explanation: 'Mars appears reddish because of the iron oxide (rust) on its surface.',
      explanationBengali:
        'মঙ্গলের পৃষ্ঠে প্রচুর পরিমাণে আয়রন অক্সাইড থাকার কারণে এটি লালচে দেখায়।',
      difficulty: 'easy',
      defaultMarks: 1.0,
    ...
    },
    {
      ...
      questionBengaliText: 'ভারতের সংবিধানের জনক কাকে বলা হয়?',
      optionA: 'Dr. B. R. Ambedkar (ড. বি. আর. আম্বেদকর)',
      optionB: 'Mahatma Gandhi (মহাত্মা গান্ধী)',
      optionC: 'Jawaharlal Nehru (জওহরলাল নেহেরু)',
      optionD: 'Dr. Rajendra Prasad (ড. রাজেন্দ্র প্রসাদ)',
      correctOption: 'A',
      explanation: 'Dr. Bhimrao Ramji Ambedkar served as the chairman of the Drafting Committee.',
      explanationBengali: 'ড. বি. আর. আম্বেদকর সংবিধানের খসড়া কমিটির সভাপতি ছিলেন।',
      difficulty: 'easy',
      defaultMarks: 1.0,
      defaultNegativeMarks: 0.25,
      sourceType: 'other',
  ...
  'test-wbp-pyq-2024': [
    {
      ...
      optionD: 'Asansol',
      correctOption: 'B',
      explanation: 'Kolkata is the capital city of West Bengal.',
      explanationBengali: 'কলকাতা হলো পশ্চিমবঙ্গের রাজধানী।',
      difficulty: 'easy',
      defaultMarks: 1.0,
      defaultNegativeMarks: 0.25,
      sourceType: 'pyq',
    ...
    },
    {
      ...
      optionA: 'Ganga (গঙ্গা)',
      optionB: 'Damodar (দামোদর)',
      optionC: 'Teesta (তিস্তা)',
      optionD: 'Rupnarayan (রূপনারায়ণ)',
      correctOption: 'B',
      explanation:
        'The Damodar River was formerly known as the Sorrow of Bengal due to frequent ravaging floods.',
      explanationBengali: 'বিধ্বংসী বন্যার কারণে দামোদর নদকে অতীতে বাংলার দুঃখ বলা হতো।',
      difficulty: 'easy',
      defaultMarks: 1.0,
      defaultNegativeMarks: 0.25,
      sourceType: 'pyq',
