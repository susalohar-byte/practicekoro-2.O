      ...
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <Reveal>
          <div className="flex flex-col items-center text-center space-y-7 sm:space-y-8">
            ...
            <div className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950/70 border border-blue-200/80 dark:border-blue-800 text-[#0062FF] dark:text-blue-400 text-xs font-black tracking-wider uppercase shadow-2xs">
            ...
            {/* 3. 2x2 Feature Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-4xl mx-auto pt-1">
              {/* Feature 1: Unlimited mock tests */}
              <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)] flex items-center gap-4 transition-transform hover:-translate-y-0.5 text-left">
            ...
            <div className="w-full max-w-4xl mx-auto rounded-2xl sm:rounded-3xl bg-gradient-to-r from-[#004BD8] via-[#0055EE] to-[#0062FF] p-6 sm:p-8 text-white shadow-2xl shadow-blue-600/30 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="space-y-1.5 text-center md:text-left z-10">
                ...
                <div className="flex items-baseline justify-center md:justify-start gap-2">
                  ...
                  <span className="text-base font-semibold text-blue-100">/ 365 days</span>
                </div>
                <div>
              ...
              <div className="flex flex-col items-center md:items-end gap-2.5 w-full md:w-auto z-10">
                <button
                  ...
                  className="w-full sm:w-auto min-w-[240px] inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl bg-white hover:bg-slate-50 text-[#0062FF] font-black text-base shadow-xl shadow-black/10 transition-all hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
                >
