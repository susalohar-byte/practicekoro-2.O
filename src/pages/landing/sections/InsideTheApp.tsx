...
const APP_FEATURES: AppFeatureItem[] = [
  ...
  },
  {
    ...
    titleBengali: 'বাংলা ও ইংরেজি উভয় ভাষায়',
    description: 'টেস্ট চলার সময় যেকোনো মুহূর্তে এক ক্লিকে প্রশ্নপত্র বাংলা অথবা ইংরেজিতে পরিবর্তন করার পূর্ণ স্বাধীনতা।',
    bullets: ['যেকোনো প্রশ্নে ইনস্ট্যান্ট ল্যাঙ্গুয়েজ সুইচ', 'অফিশিয়াল পরীক্ষার প্রমাণ্য পরিভাষা', 'বাংলা ও ইংরেজি উভয় মাধ্যমের জন্য সেরা'],
  },
];
