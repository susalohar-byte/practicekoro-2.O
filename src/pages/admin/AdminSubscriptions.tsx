...
export const AdminSubscriptions: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* --- Tab Navigation & Quick Jumps ---------------------------------- */}
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
        <div className="bg-white dark:bg-slate-900/50 rounded-2xl border border-slate-200 dark:border-slate-700/50 p-1.5 shadow-sm flex-1">
        ...
        {/* Quick links to Coupons & Revenue Analytics */}
        <div className="flex items-center gap-2 shrink-0">
          <Link
            to="/admin/coupons"
            className="inline-flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700/50 text-slate-700 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 text-xs font-bold hover:border-indigo-300 dark:hover:border-indigo-600/50 shadow-sm transition-all"
          >
